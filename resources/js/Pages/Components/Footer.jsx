    ...
    <div className='w-full sticky'>
        ...
        <div className="w-full grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            >
            <img src='/images/web/lehub-logo.png' className='h-14'/>
            </a>
            <div className="mt-6 lg:max-w-sm">
              <p className="text-sm text-gray-100">
              Lehub delivers innovative digital solutions, specializing in web and mobile app development, design, and graphics.
              </p>
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
          ...
          <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
            <li>
              <a
                href="/"
                className="text-sm text-gray-100 transition-colors duration-300 hover:text-gray-100"
              >
                F.A.Q
              </a>
            </li>
